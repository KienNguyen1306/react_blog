...
import { formatDate, formatDate2Time } from "../../helpers";

export default function ArticleItemInfo({ isShowAvatar, user, date }) {
  return (
    <div className="article-item__info">
      {isShowAvatar && <ArticleItemAvatar avatar={user.avatar} />}
